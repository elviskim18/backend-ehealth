...
Notification9 = Notification.create(about:"Head Evening roll call", doctor_id:Doctor3.id)
Notification10 = Notification.create(about:"Advice Nurse Lucy on CPR procedure", doctor_id:Doctor4.id)
Notification11 = Notification.create(about:"Weekly Doctors meeting is next week", doctor_id:Doctor4.id)
Notification12 = Notification.create(about:"Administer Weekly checkups", doctor_id:Doctor4.id)
Notification13 = Notification.create(about:"Your due to hold a meeting", doctor_id:Doctor5.id)
Notification14 = Notification.create(about:"Kindly see the HR", doctor_id:Doctor5.id)
Notification15 = Notification.create(about:"Advice Nurse Lucy on CPR procedure", doctor_id:Doctor5.id)
Notification16 = Notification.create(about:"Meeting at 12 ocklock with Dr Ryan", doctor_id:Doctor6.id)
Notification17 = Notification.create(about:"Revisit Patient Nancy Kimbo ailment history", doctor_id:Doctor6.id)
Notification18 = Notification.create(about:"Plan a surgery for Patient Jude", doctor_id:Doctor6.id)
...
Appointment6 = Appointment.create(appointment_date: "2022-9-10", time:"8:00am-9:00am", patient_id:Patient6.id, doctor_id:Doctor3.id)
Appointment7 = Appointment.create(appointment_date: "2022-9-10", time:"10:00am-11:00am", patient_id:Patient7.id, doctor_id:Doctor4.id)
Appointment8 = Appointment.create(appointment_date: "2022-10-10", time:"7:00am-8:30am", patient_id:Patient4.id, doctor_id:Doctor4.id)
Appointment9 = Appointment.create(appointment_date: "2022-8-10", time:"7:00am-9:30am", patient_id:Patient1.id, doctor_id:Doctor5.id)
Appointment10 = Appointment.create(appointment_date: "2022-9-11", time:"10:00am-11:30am", patient_id:Patient6.id, doctor_id:Doctor5.id)
Appointment11 = Appointment.create(appointment_date: "2022-9-7", time:"10:30am-11:00am", patient_id:Patient5.id, doctor_id:Doctor6.id)
Appointment12 = Appointment.create(appointment_date: "2022-9-8", time:"9:00am-10:30am", patient_id:Patient2.id, doctor_id:Doctor6.id)
